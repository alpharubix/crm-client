    ...
    <div className='p-4 space-y-4'>
      ...
      <div className='flex items-center justify-between'>
        <div>
          ...
          <p className='text-muted-foreground'>Manage and track all tasks parented under Accounts.</p>
        </div>
      ...
      {/* Two-Column Grid matching Accounts Database layout */}
      <div className='grid grid-cols-[280px_1fr] gap-4'>
        {/* Left Filter Sidebar */}
        <div className='border rounded-md p-3 space-y-4 bg-background overflow-y-auto h-[calc(100vh-140px)] flex flex-col justify-between'>
          <div className='space-y-4'>
            <h3 className='font-semibold text-sm border-b pb-2'>Filter Account Tasks by</h3>
