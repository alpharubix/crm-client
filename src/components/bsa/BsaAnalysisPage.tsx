...
import SummeryOfDebitAndCredit from './SummeryOfDebitAndCredit';
import CashFlow from './cashFlow/CashFlow';
import OverviewMonthlyWise from './OverviewMonthlyWise';

type TabType = 'summary' | 'cashflow' | 'overview';

export function BsaAnalysisPage() {
  const { id } = useParams();
  ...
  return (
    <div className=" max-w-[1400px] mx-auto w-full animate-in fade-in zoom-in duration-300">
      <div className="flex items-center gap-4 mb-6">
        ...
        <h1 className="text-2xl font-bold tracking-tight">Bank Statement Analysis</h1>
      </div>
